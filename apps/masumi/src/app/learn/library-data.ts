...
export const concepts: LearnLibraryItem[] = [
  item("sumi-ecosystem", "The Sumi ecosystem", "Where Masumi, Sokosumi, and Kodosumi sit in the journey from service execution to exchange.", "Everyone", ["Masumi coordinates portable payments and identity; Sokosumi helps people discover and access services.", "Kodosumi provides a scalable runtime for operating agentic services; none of the three replaces the service’s own product logic."], "Three complementary layers", "Masumi is the foundational protocol for agent payments and identity. Sokosumi is a marketplace experience for discovering and accessing agentic services. Kodosumi is a runtime environment for reliable, scalable execution. A product can use these layers together, but each has a separate responsibility and its own implementation documentation.", `${docs}/documentation`),
...
export const deepDives = [
  { title: "Protocol, marketplace, and runtime", summary: "Place Masumi, Sokosumi, and Kodosumi at their distinct layers without treating the ecosystem as one monolithic product.", concepts: ["sumi-ecosystem", "agentic-service", "registry"] },
