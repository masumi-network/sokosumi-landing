        ...
        <section className="pt-0 pb-24">
          <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-12">
            ...
            <p className="mt-8 text-[15px] md:text-[16px] text-[#5b5b5b] leading-[1.6] max-w-[640px]">
              ...
              for AI agents: funds are locked in the contract, released when the work is
              delivered, and refunded when it isn&apos;t — with every decision logged on-chain.
              Plugged into x402, every HTTP payment gets that protection built in.
            </p>
