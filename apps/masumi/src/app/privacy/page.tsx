      ...
      <main className="pt-[140px] pb-24">
        <div className="max-w-[720px] mx-auto px-4 md:px-8">
          ...
          <div className="prose">
            ...
            <p>
              In section 15 you will also find information on data processing in the context of video surveillance at our buildings.
            </p>
            <p>
            ...
            <p>
              We, Serviceplan Group SE &amp; Co KG, House of Communication, Friedenstr. 24, 81671 Munich, Germany, Phone: +49 89 2050 20, E-mail: <a href="mailto:info@house-of-communication.com">info@house-of-communication.com</a> (hereinafter: &quot;Serviceplan Group&quot; or &quot;we&quot;), would like to inform you in the following about the processing of your personal data within the framework of our website.
            </p>
            <p>
            ...
            <ul>
              <li>Plan.Net Germany GmbH &amp; Co. KG, House of Communication, Friedenstr. 24, 81671 Munich, E-mail: <a href="mailto:info@plan-net.com">info@plan-net.com</a>, Phone: +49 89 2050 30</li>
              <li>Mediaplus Germany GmbH &amp; Co.KG, House of Communication, Friedenstr. 24, 81671 Munich, E-mail: <a href="mailto:mediaplus@house-of-communication.com">mediaplus@house-of-communication.com</a>, Phone: +49 89 2050 50</li>
            </ul>
            <p>
            ...
            <p>
              ...
              <br />
              E-mail: <a href="mailto:datenschutz@legaldata.law">datenschutz@legaldata.law</a>
            </p>

            <h2>4. Provision and use of the website / server log files</h2>

            <h3>a) Type and scope of data processing</h3>
            <p>
            ...
            <h3>a) Nature, scope and purpose of data processing</h3>
            <p>
            ...
            <p>
              <strong>Browser settings configuration</strong>
              <br />
            ...
            <h3>d) Cookie categories</h3>

            <p>We use the following categories of cookies:</p>

            <p>
              <strong>aa) Necessary cookies</strong>
              <br />
            ...
            <p>
              <strong>bb) Statistics cookies</strong>
              <br />
            ...
            <p>
              <strong>cc) Cookies for personalization</strong>
              <br />
            ...
            <p>
              <strong>dd) Marketing cookies</strong>
              <br />
            ...
            <h3>e) Google Analytics</h3>
            <p>
              This website uses Google Analytics 4, a web analytics service provided by Google Ireland Limited (&quot;Google&quot;), Gordon House, Barrow Street, Dublin 4, Ireland. Google Analytics uses cookies that allow analysis of your use of the website. The information generated by the cookie about your use of this website (including a shortened IP address) is generally transferred to a Google server in the USA and stored there.
            </p>
            <p>
              In Google Analytics 4, IP addresses are not logged or stored. Google uses the IP address only momentarily to derive a coarse, country-level location and then discards it; we do not receive your IP address.
            </p>
            <p>
              We use Google Consent Mode v2. Before you make a choice in the cookie banner, Google Analytics does not set any cookies and does not collect personal identifiers — it transmits only anonymous, aggregated signals that cannot be used to identify you (legal basis: our legitimate interest in basic, privacy-preserving reach measurement, Art. 6 (1) (f) GDPR). Analytics cookies are set only after you accept via the cookie banner (legal basis: your consent, Art. 6 (1) (a) GDPR). You can revoke your consent at any time by declining in the banner or clearing the analytics consent cookie in your browser, after which no analytics cookies are set on subsequent visits.
            </p>
            <p>
            ...
            <h2>6. Data collection for the execution of pre-contractual measures and for the fulfillment of the contract</h2>
            ...
            <h3>b) Purpose and legal basis of the data processing</h3>
            <p>
            ...
            <p>We will only share your personal information with third parties if:</p>
            <p>
            ...
            <p>We use such service providers in the areas of:</p>
            <ul>
              <li>IT</li>
              <li>Logistics</li>
            ...
            <h2>8. Application possibility</h2>
            ...
            <p>If you make use of the contact form, the following personal data will be processed:</p>
            <ul>
              <li>Salutation</li>
              <li>Name</li>
            ...
            <h2>11. Contact options by e-mail</h2>
            <p>On our website, they have a contact option via e-mail.</p>
            ...
            <h2>12. Registration with the Serviceplan Alumni Program</h2>
            ...
            <p>If you send us a membership request via the online form, the following personal data of you will be processed via it:</p>
            <ul>
              <li>Salutation</li>
              <li>Title</li>
              <li>First name</li>
            ...
            <h2>14. Data protection notice for video conferences</h2>
            <p>
            ...
            <p>(hereinafter: video conferencing systems)</p>
            <p>
            ...
            <ul>
              <li>User details: first name, last name, phone (optional), e-mail address, password (if &quot;single sign-on&quot; is not used), profile picture (optional), department (optional).</li>
              <li>Meeting metadata: Topic, description (optional), attendee IP addresses, device/hardware information.</li>
              <li>For recordings (optional): MP4 file of all video, audio and presentation recordings, M4A file of all audio recordings, text file of online meeting chat.</li>
              <li>When dialing in with the telephone: information on the incoming and outgoing call number, country name, start and end time. If necessary, further connection data such as the IP address of the device can be stored.</li>
              <li>Text, audio and video data: You may have the option of using the chat, question or survey functions in an &quot;online meeting&quot;. To this extent, the text entries you make are processed in order to display them in the online meeting and, if necessary, to log them. In order to enable the display of video and the playback of audio, the data from the microphone of your terminal device and from any video camera of the terminal device will be processed accordingly for the duration of the meeting. You can turn off or mute the camera or microphone yourself at any time.</li>
            </ul>
            <p>
              To join an online meeting or enter the &quot;meeting room&quot;, you must at least provide information about your name.
            </p>

            <p><strong>Scope of processing</strong></p>
            <p>
            ...
            <p><strong>Legal bases of data processing</strong></p>
            <p>
            ...
            <p><strong>Recipient / passing on of data</strong></p>
            <p>
            ...
            <p><strong>Right of complaint to a supervisory authority</strong></p>
            <p>
              You have the right to complain about the processing of personal data by us to a data protection supervisory authority.
            </p>

            <p><strong>Amendment of this privacy notice</strong></p>
            <p>
            ...
            <h2>15. Video surveillance</h2>
            <p>
              If you visit us on site at our House of Communication, our video surveillance systems can record you. The systems are marked with special signs and are located at the House of Communication buildings at Friedenstraße 24, 81671 Munich and August-Everding-Straße 25, 81671 Munich or in the immediate vicinity.
            </p>
            <p>
              The legal basis for data processing is our legitimate interest in exercising our domiciliary rights and preventing or investigating any criminal offenses (Art. 6 para. 1 lit. f) GDPR).
            </p>
            <p>
              We store the video recordings for a period of up to 14 days. If there is evidence of a criminal offense, the recordings may be used for a significantly longer period, e.g. for the duration of legal proceedings.
            </p>
            <p>
              In principle, we do not pass on the recordings to external bodies outside the Serviceplan Group. However, it may be necessary to make the recordings available to external consultants, such as lawyers or law enforcement authorities, if there are indications of criminal offenses.
            </p>

            <h2>16. Data security and backup measures</h2>
            <p>
            ...
            <p>
              <strong>a) Right to revoke your data protection consent pursuant to Art. 7 (3) GDPR</strong>
              <br />
            ...
            <p>
              <strong>b) Right of access according to Art. 15 GDPR</strong>
              <br />
            ...
            <p>
              <strong>c) Right to rectification and completion according to Art. 16 GDPR</strong>
              <br />
            ...
            <p>
              <strong>d) Right to erasure (&quot;right to be forgotten&quot;) according to Art. 17 GDPR</strong>
              <br />
            ...
            <p>
              <strong>e) Right to restriction of processing according to Art. 18 GDPR</strong>
              <br />
              You have a right to restrict processing, e.g. if you believe that the personal data is incorrect.
            </p>
            <p>
              <strong>f) Right to data portability according to Art. 20 GDPR</strong>
              <br />
            ...
            <p>
              <strong>g) Right of objection according to Art. 21 GDPR</strong>
              <br />
            ...
            <p>
              <strong>h) Automated decision in individual cases including profiling according to Art. 22 GDPR</strong>
              <br />
            ...
            <p>
              <strong>i) Complaint to a data protection supervisory authority pursuant to Art. 77 GDPR</strong>
              <br />
            ...
            <hr />
            <p className="text-[14px] text-[#999]">Status: February 2025</p>
          </div>
        </div>
      </main>
