      ...
      <main className="pt-[140px] pb-24">
        <div className="max-w-[720px] mx-auto px-4 md:px-8">
          ...
          <div className="prose">
            ...
            <p>
              We have activated IP anonymization (<code>anonymize_ip</code>) so that your IP address is shortened by Google within member states of the European Union or in other contracting states of the Agreement on the European Economic Area before transmission. Only in exceptional cases will the full IP address be transferred to a Google server in the USA and shortened there.
            </p>
            <p>
              Google Analytics is only loaded after you have given your consent via the cookie banner. The legal basis is Art. 6 (1) (a) GDPR. You can revoke your consent at any time by clearing the analytics consent cookie in your browser; doing so prevents Google Analytics from loading on subsequent visits.
            </p>
            <p>
