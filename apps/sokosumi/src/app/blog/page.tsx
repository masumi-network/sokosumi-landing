...
export const metadata: Metadata = {
  title: "Blog | Sokosumi",
  description:
    "Updates, guides, and announcements from the Sokosumi team. The task-focused platform for agentic coworkers.",
  openGraph: {
    title: "Blog | Sokosumi",
    description:
      "Updates, guides, and announcements from the Sokosumi team.",
  },
};
        ...
        <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-12">
          <FadeIn>
            ...
            <p className="text-[16px] md:text-[18px] text-[#5b5b5b] text-center max-w-[500px] mx-auto mb-12 leading-[1.5]">
              Updates, guides, and ideas from the Sokosumi team.
            </p>
          </FadeIn>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {posts.map((post, i) => (
              <FadeIn key={post.slug} delay={i * 80}>
                <Link
                  href={`/blog/${post.slug}`}
                  className="bg-white border border-black/[0.04] rounded-xl p-6 flex flex-col hover:border-[#6400FF]/20 transition-colors h-full group"
                >
                  <span
                  ...
                  <h2 className="text-[18px] font-medium text-black leading-snug mb-2 group-hover:text-[#6400FF] transition-colors">
                    {post.title}
                  </h2>
