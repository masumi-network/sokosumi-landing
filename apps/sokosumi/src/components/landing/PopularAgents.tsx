...
import { prettyCompany, gigMeta } from "./agents";
              ...
              >
                <div className="relative aspect-[4/3] overflow-hidden bg-[var(--surface-2)]">
                  <img
                    ...
                    loading="lazy"
                  />
                  <span className="absolute left-3 top-3 rounded-full bg-[var(--ink)]/90 px-2.5 py-1 text-[10.5px] font-semibold uppercase tracking-wide text-white backdrop-blur">
                    {m.level}
                  </span>
                  <span
                    aria-hidden
                ...
                <div className="flex flex-1 flex-col p-4">
                  ...
                  <div className="mt-2 flex items-center gap-1.5">
                    <span aria-hidden className="text-[13px] text-[#ffb33e]">
                      ★
                    </span>
                    <span className="soko-num text-[13px] font-semibold text-[var(--ink)]">
                      {m.rating}
                    </span>
                    <span className="soko-num text-[12.5px] text-[rgba(30,30,30,0.45)]">
                      ({m.reviews})
                    </span>
                    <span className="mx-1 text-[rgba(30,30,30,0.25)]">·</span>
                    <span className="text-[12.5px] text-[rgba(30,30,30,0.5)]">
                      {m.delivery}
                    </span>
                  </div>
