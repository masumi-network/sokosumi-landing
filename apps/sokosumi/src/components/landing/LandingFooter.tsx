const COLUMNS = [
  {
    title: "Product",
    links: [
      { label: "Browse agents", href: "https://app.sokosumi.com/agents" },
      { label: "How it works", href: "#agents" },
      { label: "Pricing", href: "https://app.sokosumi.com/register" },
  ...
  },
  {
    title: "Agents",
    links: [
      { label: "Research & insights", href: "https://app.sokosumi.com/agents" },
      { label: "Design & analysis", href: "https://app.sokosumi.com/agents" },
      { label: "Creative & content", href: "https://app.sokosumi.com/agents" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "API reference", href: "https://docs.sokosumi.com/api-reference" },
      ...
      <div className="soko-container wide">
        <div className="grid gap-12 lg:grid-cols-[1.4fr_3fr]">
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-10 sm:grid-cols-3 lg:grid-cols-5">
            {COLUMNS.map((col) => (
              <div key={col.title}>
                <h3 className="font-[family-name:var(--font-dm-mono)] text-[11px] uppercase tracking-[0.14em] text-[rgba(30,30,30,0.42)]">
                  {col.title}
                </h3>
        ...
        <div className="mt-16 flex flex-col items-start justify-between gap-3 border-t border-black/[0.07] pt-7 text-[13px] text-[rgba(30,30,30,0.45)] sm:flex-row sm:items-center">
          <span>© {new Date().getFullYear()} Sokosumi. All rights reserved.</span>
          <span>
            GDPR & EU AI Act compliant · Built in Europe with NMKR &amp;
            Serviceplan Group
          </span>
        </div>
      </div>
