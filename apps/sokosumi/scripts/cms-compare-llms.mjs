...
const ROWS = {
  ...
  de: ["Für wen", "Was zurückkommt", "Wo die Arbeit landet", "Wer es baut und betreibt", "Wofür Sie zahlen", "EU-Hosting", "Ausprobieren"],
};
const SOKO = {
  ...
  de: ["Marketingteams", "Eine fertige Datei an der Aufgabe: Report, Deck, Tabelle, Dashboard", "Auf einem Task-Board, das das ganze Team sieht", "Namentlich genannte Anbieter mit öffentlichem Profil", "Credits, nur wenn eine Aufgabe läuft", "Ja, je Coworker angegeben", "250 Credits pro Seat gratis, ohne Karte"],
};
const UI = {
  ...
  de: { eyebrow: "Vergleich", cta: "Kostenlos starten", cta2: "Mit dem Vertrieb sprechen", grid: "In der Praxis", faq: "Fragen, die wir bekommen", band: "Der Unterschied an einer Aufgabe", bandSub: "250 Credits pro Seat gratis. Coworker briefen, Datei zurückbekommen, vergleichen.", column: "Sokosumi" },
};
...
const PAGES = [
  {
    ...
    de: {
      ...
      a: "ChatGPT ist ein Chatfenster. Sie schreiben den Prompt, beurteilen die Antwort und kopieren sie irgendwohin. Sokosumi ist ein Team benannter Coworker, die Sie briefen; die fertige Datei landet auf einem Board, das Ihre Kollegen sehen.",
      cells: ["Alle; eine Person pro Chat", "Antworten im Chat; Dateien im Agent-Modus", "In Ihrem eigenen Chatverlauf", "OpenAI", "Pauschaler Seat, ab 20–25 $, genutzt oder nicht", "Nur im Enterprise-Plan", "Gratis-Stufe mit Limits"],
      grid: [
        ["Sie wählen einen Spezialisten, keinen Prompt", "Hannah macht Research, Maya Kreation. Jede hat eine Rolle, ein Profil und Beispielarbeit, die Sie vor dem ersten Credit öffnen können."],
        ["Das Team sieht die Arbeit", "Ein ChatGPT-Gespräch gehört dem, der getippt hat. Eine Sokosumi-Aufgabe zeigt, wer sie hat, ob sie läuft oder auf Sie wartet, und die Datei, wenn sie fertig ist."],
      ...
      faq: [
        ["Ist das ChatGPT mit schönerer Oberfläche?", "Nein. Sie schreiben nie einen System-Prompt. Anbieter bauen und betreiben die Coworker; Sie briefen sie und holen die Datei ab."],
        ["Wir zahlen schon für ChatGPT Team. Warum das dazu?", "Behalten Sie ChatGPT für schnelle Fragen. Nutzen Sie Sokosumi für Arbeit, die als Ergebnis enden muss, das jemand anderes übernimmt."],
  ...
  },
  {
    ...
    de: {
      ...
      a: "Mehrere Sokosumi-Coworker laufen auf Claude-Modellen. Der Unterschied ist nicht das Modell. Claude ist ein Assistent, mit dem Sie sprechen. Sokosumi ist ein Roster von Spezialisten, die Dateien auf ein gemeinsames Board liefern.",
      cells: ["Alle; eine Person pro Chat", "Antworten, Artifacts, Dateien; Cowork führt Aufgaben aus", "In Ihren Chats und Projects", "Anthropic", "Pauschaler Seat, 20–125 $", "Nicht in Anthropics eigenen Plänen", "Gratis-Stufe mit Limits"],
      grid: [
        ...
        ["Ein Assistent vs. ein Roster", "Claude ist ein Assistent, den Sie mit Projekten und Anweisungen einrichten. Sokosumi gibt einem Marketingteam benannte Spezialisten mit je einer Aufgabe – niemand muss Prompt-Ingenieur werden."],
      ...
      faq: [
        ...
        ["Unser Markenkontext liegt in Claude Projects. Geht der verloren?", "Nein. Dokumente hängen als Kontext an einer Aufgabe, und ein Sokosumi-Projekt bündelt Beschreibung, Aufgaben und Dateien für ein Vorhaben."],
        ["Ist es günstiger als Claude Team?", "Kommt auf die Nutzung an. Ein Seat mit zwei Reports im Monat kostet einen Bruchteil eines pauschalen Seats. Jede Aufgabe zeigt ihren Preis vor dem Start."],
      ],
    },
  },
  {
    ...
    de: {
      ...
      a: "Claude Code ist ein Coding-Agent, der im Terminal und im Repository lebt. Sokosumi ist ein Marktplatz für Coworker, die ein Marketingteam in normaler Sprache brieft. „Das könnten unsere Entwickler bauen“ stimmt manchmal; hier steht, was das heißt.",
      ...
      grid: [
        ...
        ["Wer es am Laufen hält", "Einen selbst gebauten Agenten muss Ihr Team reparieren, wenn sich ein Modell oder eine Datenquelle ändert. Einen Sokosumi-Coworker betreibt ein namentlich genannter Anbieter mit öffentlichem Profil."],
      ...
      faq: [
        ["Können unsere Entwickler dasselbe bauen?", "Einen Agenten für einen Job – ja, wenn sie ihn danach betreuen. Ein Roster mit Profilen, ein gemeinsames Board, Credits und Anbieter-Support ist das, was Sokosumi schon ist."],
        ["Gibt es auf Sokosumi etwas für Entwickler?", "Ja. Anbieter listen Coworker über die Developer-Plattform, und jeder MCP-Client kann Ihre Coworker aufrufen."],
        ["Wann ist Claude Code die richtige Antwort?", "Wenn Sie Entwickler, einen sehr spezifischen internen Workflow und Zeit dafür haben. Anbieter können auch einen individuellen Coworker für Ihren Workspace listen."],
      ],
    },
  },
  {
    ...
    de: {
      ...
      a: "Copilot ist ein allgemeiner Assistent in Word, Excel, PowerPoint und Teams, bezahlt pro Nutzer – genutzt oder nicht. Sokosumi ergänzt Marketing-Spezialisten, die in Ihre Teams-Channels posten und nichts kosten, bis eine Aufgabe läuft.",
      cells: ["Microsoft-365-Nutzer", "Word-, Excel- und PowerPoint-Dateien; Researcher- und Analyst-Reports", "In den Office-Apps und in Teams", "Microsoft", "Pauschales Add-on, 21–30 $ pro Nutzer", "EU Data Boundary; Flex Routing kann Inferenz aus der EU verlagern", "Bezahltes Add-on, kein Free-Plan"],
      grid: [
        ["Ergänzung, kein Entweder-oder", "Coworker liefern Office-Dateien in einen Teams-Channel. Teams mit Copilot behalten ihn für die eigenen Dokumente und nehmen Sokosumi für Arbeit, die einen Spezialisten braucht."],
        ["Spezialist schlägt Generalist", "Copilots Researcher ist ein Agent für alles. Sokosumi hat einen Coworker für Wettbewerbs-Research, einen für SEO-Audits, einen für den Wochenreport – je mit einem Anbieter dahinter."],
        ["Wo die Inferenz läuft", "Microsofts Flex Routing kann Copilot-Inferenz zu Spitzenzeiten aus der EU verlagern. Sokosumi-Coworker nennen ihr Hosting im Profil; EU-Hosting ist verfügbar."],
      ],
      faq: [
        ["Wir zahlen schon 30 $ pro Seat für Copilot. Warum das dazu?", "Copilot ist eine Pauschale, ob jemand ihn nutzt oder nicht. Sokosumi-Credits gehen nur für Aufgaben drauf, die laufen; ein Seat mit zwei Reports im Monat kostet wenig."],
        ["Funktioniert es in Teams?", "Ja. Erwähnen Sie einen Coworker in einem Channel, er antwortet im Thread; die Datei landet auf dem Task-Board."],
        ["Können wir stattdessen eigene Agenten bauen?", "Mit Copilot Studio ja, gegen Credits. Sokosumis Anbieter haben ihre schon gebaut und betreiben sie; individuelle Coworker lassen sich für Ihren Workspace listen."],
      ],
    },
  },
  {
    ...
    de: {
      ...
      a: "Gemini ist am stärksten in Google Docs, Sheets und Slides. Sokosumi liefert Office- und PDF-Dateien auf ein Team-Board, egal welche Suite Sie nutzen – von Coworkern mit je einem namentlich genannten Anbieter.",
      cells: ["Google-Workspace-Nutzer", "Docs, Sheets, Slides; NotebookLM-Reports", "In Google Workspace", "Google", "Pauschaler Seat, etwa 21–50 $ pro Nutzer", "EU-Regionen, einige Funktionen ausgenommen", "Gratis-Stufe mit Limits"],
      grid: [
        ...
        ["Agenten mit Eigentümer", "Gemini Enterprise hat eine Agent-Galerie. Auf Sokosumi hat jeder Coworker einen Anbieter, dessen Name, Modelle und Hosting im Profil stehen."],
        ["EU-Hosting ohne Fußnoten", "Googles EU-Residenz schließt einige Gemini-Funktionen aus. Sokosumi-Coworker nennen ihr Hosting; EU-Hosting ist verfügbar."],
      ],
      faq: [
        ...
        ["Macht Sokosumi Research wie NotebookLM oder Deep Research?", "Research-Coworker liefern einen Report als PDF auf das Board, mit lizenzierten Datenquellen, wo der Anbieter sie bereitstellt."],
        ["Was kostet es neben Gemini?", "Gemini ist ein pauschaler Seat. Sokosumi-Credits gehen nur für Aufgaben drauf, die laufen, und jede zeigt ihren Preis vorab."],
      ],
    },
  },
  {
    ...
    de: {
      ...
      a: "Langdock ist ein EU-gehosteter KI-Arbeitsplatz, in dem alle Mitarbeitenden mit Modellen chatten und eigene Agenten bauen. Sokosumi ist ein Marktplatz fertiger Marketing-Coworker, die Anbieter bauen und betreiben und die fertige Dateien liefern.",
      cells: ["Alle Mitarbeitenden; chatten und eigene Agenten bauen", "Chat-Antworten; Agenten, die Sie konfigurieren", "In Langdock", "Sie bauen sie; Langdock hostet", "Pauschaler Seat, 25–99 € pro Nutzer", "Ja", "7 Tage testen"],
      grid: [
        ...
        ["Gleicher Preispunkt, anderer Zähler", "Langdock berechnet 25 € pro Nutzer und Monat. Sokosumis Starter kostet 25 € pro Seat mit Credits, die nur für laufende Aufgaben draufgehen."],
      ],
      faq: [
        ["Wir haben schon Langdock. Warum Sokosumi dazu?", "Behalten Sie Langdock für den allgemeinen Chat im Unternehmen. Nehmen Sie Sokosumi dort, wo Marketing einen Spezialisten und ein Ergebnis braucht, kein Gespräch."],
        ...
        ["Können wir eigene Agenten auf Sokosumi listen?", "Ja. Anbieter – auch Ihr eigenes Team – können über die Developer-Plattform einen Coworker für Ihren Workspace listen."],
      ],
    },
  },
  {
    ...
    de: {
      ...
      cells: ["Kleine Marketingteams und Agenturen", "Content-Stücke von 28+ benannten Agenten", "In der Whaaat-App", "Ein Anbieter: UFOstart, Berlin", "Pauschal 25 $ im Monat, alle Agenten", "Nicht veröffentlicht", "7 Tage testen"],
      grid: [
        ...
        ["Content vs. Ergebnisse", "Whaaat schreibt Posts und Texte. Sokosumi-Coworker liefern auch Research-Reports, Tabellen und Dashboards auf ein Board, das das Team teilt."],
      ...
      faq: [
        ["Was ist günstiger?", "Für eine Person, die den ganzen Tag Posts schreibt, vielleicht die 25-$-Pauschale. Für ein Team mit ein paar Aufgaben pro Woche gehen Sokosumi-Credits nur für diese Aufgaben drauf."],
  ...
  },
  {
    ...
    de: {
      ...
      a: "Viktor ist ein einzelner AI Coworker in Slack und Teams, der Reports, Tabellen und PDFs zurückschickt. Sokosumi ist ein Roster von Spezialisten mehrerer Anbieter, mit Task-Board und öffentlichen Profilen – und Credits, die nur für laufende Arbeit draufgehen.",
      cells: ["Wissensarbeit-Teams in Slack und Teams", "Reports, Tabellen, PDFs, Dashboards", "In Slack- oder Teams-Threads", "Viktor, ein generischer Coworker", "Nicht veröffentlicht", "Nicht veröffentlicht", "Nicht veröffentlicht"],
      grid: [
        ["Ein Coworker vs. ein Roster", "Viktor ist ein Assistent für alles. Sokosumi gibt Ihnen Research, Strategie, Kreation und Spezial-Agenten – je mit einem Profil, das Sie vorher lesen können."],
        ["Anbieter, die man sieht", "Jeder Sokosumi-Coworker nennt Anbieter, Modelle und Hosting. Das ist die Grundlage für das Gespräch mit IT und Einkauf."],
        ["Ein Board, nicht nur ein Thread", "Threads scrollen weg. Eine Sokosumi-Aufgabe behält Status und Datei auf einem Board, mit geplanten Läufen, wenn Sie sie brauchen."],
      ],
      faq: [
        ["Funktioniert Sokosumi auch in Teams und Slack?", "Coworker antworten heute in Sokosumi-Channels; Google- und Microsoft-Konten lassen sich für Kontext verbinden. Fragen Sie den Vertrieb nach Ihrem Setup."],
        ...
        ["Wie vergleichen sich die Preise?", "Viktor hat keine Preise veröffentlicht. Sokosumis sind öffentlich: gratis mit 250 Credits pro Seat, dann 25 €, 75 € und 200 € pro Seat."],
      ],
    },
  },
  {
    ...
    de: {
      ...
      a: "Dust ist ein europäischer Arbeitsplatz, in dem Sie Agenten auf Ihren eigenen Unternehmensdaten bauen. Sokosumi ist ein Marktplatz, auf dem Anbieter Marketing-Coworker schon gebaut haben, die fertige Dateien liefern.",
      ...
      grid: [
        ["Bauen vs. beauftragen", "Dust gibt Ihnen das Werkzeug zum Bauen. Sokosumi gibt Ihnen den Coworker: eine Rolle, Beispielarbeit, einen Anbieter, der dafür verantwortlich ist."],
        ...
        ["Credits so oder so", "Beide zählen Credits auf einem Seat. Auf Sokosumi zeigt jede Aufgabe ihren Preis vorab, und der Free-Plan erneuert monatlich 250 Credits pro Seat."],
      ],
      faq: [
        ["Können Sokosumi-Coworker unsere Dokumente nutzen?", "Ja. Hängen Sie sie als Kontext an eine Aufgabe oder ein Projekt."],
        ["Brauchen wir jemanden, der Agenten pflegt?", "Nein. Anbieter bauen und betreiben die Coworker. Individuelle Coworker kann ein Anbieter für Ihren Workspace listen."],
  ...
  },
  {
    ...
    de: {
      ...
      a: "Jasper ist eine Content-Plattform mit Agenten für Texte, Kampagnen und Markenstimme – alle von Jasper. Sokosumi ist ein Marktplatz für Coworker mehrerer Anbieter, die auch Research, Analyse und Reporting machen und Dateien auf ein gemeinsames Board liefern.",
      cells: ["Marketing- und Content-Teams", "Texte und Content von 100+ Agenten", "In Jasper Canvas", "Jasper", "Pauschaler Seat, 59–69 $", "US-Hosting", "Testphase"],
      grid: [
        ["Content vs. der ganze Job", "Jasper schreibt. Sokosumi-Coworker recherchieren auch den Markt, bauen die Tabelle und liefern das Dashboard."],
        ...
        ["Pauschaler Seat vs. Credits", "Jasper berechnet jeden Seat jeden Monat. Sokosumi-Credits gehen nur für Aufgaben drauf, die laufen – ab dem Free-Plan."],
      ],
      faq: [
        ...
        ["Hält Sokosumi unsere Markenstimme?", "Hängen Sie den Brand Guide an ein Projekt; die Coworker arbeiten damit."],
  ...
  },
  {
    ...
    de: {
      ...
      a: "Lindy ist ein No-Code-Werkzeug, mit dem Sie eigene KI-Assistenten für E-Mail, Meetings und CRM bauen. Sokosumi ist ein Marktplatz für Marketing-Coworker, die Anbieter gebaut haben und betreiben und die fertige Dateien auf ein Team-Board liefern.",
      cells: ["Einzelpersonen und kleine Teams", "Automatisierungen und Assistenten-Antworten", "In E-Mail, Kalender, CRM", "Sie bauen sie; Lindy hostet", "Seat mit Credits, 30–200 $", "US-Hosting", "7 Tage testen, kein Free-Plan"],
      grid: [
        ...
        ["Persönliche Admin-Arbeit vs. Marketing-Ergebnisse", "Lindy ist für Posteingang und Kalender. Sokosumi ist für die Wettbewerbsanalyse, den Kampagnenplan, den Wochenreport."],
        ["Gleicher Zähler, anderer Free-Plan", "Beide berechnen einen Seat mit Credits. Sokosumis Free-Plan hat jeden Monat 250 Credits pro Seat; Lindy hat eine Testphase."],
      ],
      faq: [
        ["Kann Sokosumi meinen Posteingang automatisieren?", "Nicht seine Aufgabe. Es führt Marketingaufgaben aus, die als Dateien enden. Geplante Aufgaben übernehmen die wiederkehrenden."],
  ...
  },
  {
    ...
    de: {
      ...
      a: "Manus ist ein allgemeiner autonomer Agent für eine Person. Sokosumi ist ein Marktplatz für Marketing-Coworker für ein Team, je mit namentlich genanntem Anbieter, öffentlichem Profil und einem Platz auf einem gemeinsamen Board.",
      ...
      grid: [
        ["Ein Team-Produkt", "Manus-Aufgaben gehören der Person, die sie gestartet hat. Sokosumi-Aufgaben liegen auf einem Board mit Status, Zuständigkeit und Datei – sichtbar fürs Team."],
      ...
      faq: [
        ["Kann Sokosumi offene Aufgaben wie Manus?", "Coworker arbeiten nach einem Briefing in normaler Sprache. Vorlagen geben ein festes Briefing mit Beispiel zum Vorab-Prüfen."],
        ["Ist das eine Compliance-Frage?", "Für viele DACH-Unternehmen ja. Sokosumi nennt auf jedem Profil Anbieter, Modelle und Hosting."],
        ["Wie vergleichen sich die Preise?", "Beide nutzen Credits. Sokosumis Free-Plan erneuert monatlich 250 Credits pro Seat; bezahlte Seats beginnen bei 25 €."],
      ],
    },
  },
  {
    ...
    de: {
      ...
      a: "Relevance AI ist ein Baukasten: Sie setzen eine „AI Workforce“ aus Agenten und Tools zusammen. Sokosumi ist ein Marktplatz, auf dem diese Workforce schon existiert – von Anbietern gebaut und betrieben, mit Task-Board und fertigen Dateien.",
      ...
      grid: [
        ...
        ["Wer es pflegt", "Einen selbst gebauten Workflow reparieren Sie. Einen Sokosumi-Coworker hält der Anbieter am Laufen."],
      ],
      faq: [
        ["Können wir unsere gebauten Agenten mitbringen?", "Anbieter – auch Ihr eigenes Team – können über die Developer-Plattform einen Coworker für Ihren Workspace listen."],
        ["Ist Sokosumi auch für Sales-Teams?", "Es ist für Marketing gebaut. Manche Coworker decken Sales-Research und Outreach-Planung ab; siehe Profile."],
  ...
  },
  {
    ...
    de: {
      ...
      a: "Perplexity beantwortet Fragen mit Quellen, und Labs macht daraus Reports. Sokosumi-Research-Coworker erledigen den Report als Aufgabe: lizenzierte Daten, wo der Anbieter sie bereitstellt, ein namentlich genannter Anbieter, der dafür geradesteht, und das PDF auf dem Team-Board.",
      cells: ["Alle, die recherchieren", "Antworten mit Quellen; Reports in Labs", "In Ihren Perplexity-Threads", "Perplexity", "Pauschaler Seat, ab 20–40 $", "Nicht veröffentlicht", "Gratis-Stufe"],
      grid: [
        ["Websuche vs. lizenzierte Daten", "Perplexity liest das offene Web. Mehrere Sokosumi-Research-Coworker ergänzen lizenzierte Quellen, im Profil angegeben."],
        ["Ein Thread vs. eine Aufgabe", "Ein Perplexity-Report lebt in Ihrem Thread. Ein Sokosumi-Report ist eine Aufgabe mit Zuständigkeit, Status und PDF auf dem Board – und läuft auf Wunsch nach Zeitplan."],
        ["Mehr als Research", "Sokosumi-Coworker planen auch die Kampagne, schreiben das Deck und bauen das Dashboard."],
      ],
      faq: [
        ["Was ist besser für eine schnelle Faktenfrage?", "Perplexity. Sokosumi ist für den Report, den Sie jemand anderem geben."],
        ["Kann Research wöchentlich von allein laufen?", "Ja. Geplante Aufgaben liefern den Montags-Wettbewerbsreport ohne Prompt."],
  ...
  },
  {
    ...
    de: {
      ...
      a: "Breeze-Agenten leben in HubSpot und erledigen CRM-Ergebnisse: gelöste Anfragen, qualifizierte Leads. Sokosumi ist ein Marktplatz für Marketing-Coworker, die Reports, Pläne und Dashboards auf ein Board liefern – egal welches CRM Sie nutzen.",
      ...
      grid: [
        ...
        ["In einem Tool vs. jeder Stack", "Breeze braucht HubSpot. Sokosumi liefert Dateien auf ein Board und verbindet Google- und Microsoft-Konten für Kontext."],
      ...
      faq: [
        ...
        ["Verbindet sich Sokosumi mit HubSpot?", "Jeder MCP-Client kann Sokosumi-Coworker aufrufen. Fragen Sie den Vertrieb nach Ihrem Setup."],
  ...
  },
  {
    ...
    de: {
      ...
      grid: [
        ...
        ["Solo vs. Team", "Sintra ist für eine Inhaberin gebaut. Sokosumi hat Organisationen, Rollen, ein gemeinsames Board und Enterprise-Verträge."],
      ],
      faq: [
        ["Ist Sokosumi zu groß für ein kleines Team?", "Nein. Der Free-Plan ist ein Seat mit 250 Credits; bezahlte Seats beginnen bei 25 €."],
