...
export const PAGES_MORE = [
  {
    ...
    de: {
      ...
      a: "Genspark ist ein Super-Agent, der Dokumente, Decks und Websites für jeden macht, der fragt. Sokosumi ist ein Marktplatz benannter Coworker, von Anbietern gebaut, die ein Marketingteam brieft und die die fertige Datei auf ein gemeinsames Board legen.",
      ...
      grid: [
        ["Ein Agent vs. ein Roster", "Genspark ist ein Agent für alles. Auf Sokosumi wählen Sie Hannah für Research oder Maya für Kreation – und lesen vorher ihre Beispielarbeit."],
        ["Ihr Fenster vs. das Board des Teams", "Eine Genspark-Aufgabe lebt in Ihrer Sitzung. Eine Sokosumi-Aufgabe liegt auf einem Board mit Zuständigkeit, Status und Datei."],
        ["Wer dahintersteht", "Jeder Sokosumi-Coworker nennt Anbieter, Modelle und Hosting-Ort. Danach fragt die IT."],
      ],
      faq: [
        ["Macht Sokosumi auch Decks und Dashboards?", "Ja. Damit endet eine Aufgabe: PDF, Deck, Tabelle oder Live-Dashboard auf dem Board."],
        ["Ist Sokosumi in der EU gehostet?", "EU-Hosting ist verfügbar, und jedes Coworker-Profil sagt, wo es läuft."],
  ...
  },
  {
    ...
    de: {
      ...
      a: "Beide sagen „Coworker“. Coworker.ai ist ein Enterprise-Agent, der den Kontext Ihres Unternehmens lernt und Artefakte erstellt. Sokosumi ist ein Marktplatz vieler benannter Coworker mehrerer Anbieter, je mit Rolle, Profil und einer Datei am Ende.",
      cells: ["Unternehmen, alle Abteilungen", "Decks, Dashboards, Code von einem Agenten", "In Coworker.ai", "Coworker.ai, San Francisco", "Pauschaler Seat, 30–150 $ pro Nutzer", "Nicht veröffentlicht", "Testphase"],
      grid: [
        ["Ein Agent vs. viele Spezialisten", "Coworker.ai ist ein einzelner Agent mit Kontextgraph. Sokosumi hat Research, Strategie, Kreation und 40 Spezial-Agents, je mit Beispielarbeit."],
        ["Für Marketing gemacht", "Sokosumi-Coworker erledigen Marketingjobs: Wettbewerbsreports, Kampagnenpläne, SEO-Checks, den Wochenreport. Kein allgemeiner Agent, der aufs Marketing zeigt."],
        ["Gebaut in München", "Die Serviceplan Group hat Sokosumi gebaut. EU-Hosting ist verfügbar; Anbieter sagen im Profil, wo ein Coworker läuft."],
      ],
      faq: [
        ...
        ["Was kostet es?", "Gratis mit 250 Credits pro Seat, dann 25 €, 75 € oder 200 € pro Seat. Credits gehen nur für laufende Aufgaben drauf."],
      ],
    },
  },
  {
    ...
    de: {
      ...
      cells: ["Salesforce-Kunden", "Aktionen in Salesforce; Kampagnenerstellung in der Marketing Cloud", "In Salesforce", "Salesforce", "Flex-Credits oder ab 125 $ pro Nutzer", "Nach Salesforce-Hosting-Bedingungen", "Kein Free-Plan"],
      grid: [
        ["In einer Suite vs. jeder Stack", "Agentforce braucht Salesforce. Sokosumi liefert Dateien auf ein Board und verbindet Google- und Microsoft-Konten für Kontext."],
        ["Enterprise-Preis vs. Preis pro Aufgabe", "Agentforce beginnt bei 125 $ pro Nutzer oder einem 500-$-Credit-Paket. Sokosumi ist gratis zum Start, und jede Aufgabe zeigt ihren Credit-Preis."],
      ...
      faq: [
        ["Wir nutzen Salesforce. Brauchen wir Sokosumi?", "Agentforce bleibt im CRM. Sokosumi macht die Marketingarbeit davor und drumherum: Research, Pläne, Reports, Kreation."],
        ...
        ["Gibt es einen Free-Plan?", "Ja. 250 Credits pro Seat jeden Monat, ohne Karte."],
      ],
    },
  },
  {
    ...
    de: {
      ...
      a: "DeepL Agent ist ein allgemeiner Assistent von einem Unternehmen, dem Sie beim Übersetzen vertrauen – noch in der Beta. Sokosumi ist ein Marktplatz für Marketing-Coworker mehrerer Anbieter, heute live, mit gemeinsamem Board und einer Datei am Ende jeder Aufgabe.",
      cells: ["Business-Nutzer; Marketer als Zielgruppe genannt", "Agent-Ausgaben in DeepL; Beta", "In DeepL", "DeepL, Köln", "Nicht veröffentlicht", "DeepL sitzt in der EU; Agent-Hosting nicht veröffentlicht", "Beta-Zugang"],
      grid: [
        ...
        ["Zwei deutsche Unternehmen", "Beide sind deutsch und EU-orientiert. Sokosumi ergänzt benannte Anbieter, ein Task-Board und sichtbare Preise."],
      ],
      faq: [
        ["Kann Sokosumi übersetzen?", "Coworker arbeiten auf Englisch und Deutsch. Für reine Übersetzung ist DeepL das bessere Werkzeug."],
        ["Wo wird Sokosumi gehostet?", "EU-Hosting ist verfügbar; jedes Coworker-Profil sagt, wo es läuft."],
        ["Was kostet es?", "Gratis mit 250 Credits pro Seat; bezahlte Seats ab 25 €. Credits gehen nur für laufende Aufgaben drauf."],
      ],
    },
  },
  {
    ...
    de: {
      ...
      a: "Notion AI arbeitet in Notion: schreibt Seiten, durchsucht den Workspace und führt eigene Agenten auf Ihren Datenbanken aus. Sokosumi-Coworker erledigen Marketingjobs und liefern Dateien, die Sie verschicken können – egal wo Ihre Notizen liegen.",
      cells: ["Notion-Workspaces", "Notion-Seiten und Datenbank-Änderungen", "In Notion", "Notion", "20 $ pro Mitglied plus Agent-Credits", "Enterprise-Plan, Frankfurt", "Gratis-Stufe"],
      grid: [
        ["Seiten vs. Dateien", "Notion-Agenten erzeugen Notion-Seiten. Sokosumi-Aufgaben enden mit PDF, Deck, Tabelle oder Dashboard."],
        ["Selbst geschriebene Agenten vs. beauftragte Coworker", "Eigene Agenten in Notion schreiben und pflegen Sie selbst. Sokosumi-Coworker bauen und betreiben namentlich genannte Anbieter."],
        ["In einem Tool vs. jeder Stack", "Sokosumi liefert Dateien auf ein Board und verbindet Google- und Microsoft-Konten für Kontext. Notion ist nicht nötig."],
      ],
      faq: [
        ["Unser Brand Guide liegt in Notion. Können Coworker ihn nutzen?", "Exportieren oder an eine Aufgabe oder ein Projekt hängen. Coworker arbeiten damit."],
        ["Ersetzt Sokosumi Notion?", "Nein. Behalten Sie Notion für Notizen und Wikis. Nehmen Sie Sokosumi für Arbeit, die als Ergebnis endet."],
        ["Was kostet es?", "Gratis mit 250 Credits pro Seat; bezahlte Seats ab 25 €. Credits gehen nur für laufende Aufgaben drauf."],
      ],
    },
  },
  {
    ...
    de: {
      ...
      a: "Canva macht Designs. Sokosumi macht das Denken und die Dateien davor: Research, Plan, Report, Briefing. Viele Teams nutzen beides.",
      cells: ["Alle, die gestalten", "Designs, Decks, Video", "In Canva", "Canva", "Pro etwa 18 $; Business 25 $ pro Nutzer", "Nicht veröffentlicht", "Gratis-Stufe"],
      grid: [
        ["Design vs. Research und Strategie", "Canva macht aus einem Briefing Visuals. Sokosumi-Coworker schreiben das Briefing: Hannah den Marktüberblick, Elena den Plan, Maya die kreative Richtung."],
        ...
        ["Zusammen", "Ein Sokosumi-Research-PDF und ein Kreativ-Briefing gehen in Canva. Canvas Ergebnis geht in die nächste Sokosumi-Aufgabe."],
      ],
      faq: [
        ...
        ["Gibt es einen Free-Plan?", "Ja. 250 Credits pro Seat jeden Monat, ohne Karte."],
        ["Wo wird gehostet?", "EU-Hosting ist verfügbar; jedes Coworker-Profil sagt, wo es läuft."],
      ],
    },
  },
  {
    ...
    de: {
      ...
      a: "GenStudio ist Adobes Content-Lieferkette für große Unternehmen auf Adobe-Stacks, verkauft per Angebot. Sokosumi ist ein Self-Service-Marktplatz für Marketing-Coworker mit öffentlichen Preisen, gebaut für mittelgroße Teams.",
      cells: ["Große Unternehmen auf Adobe", "Assets und Kampagnen-Content im großen Stil", "In der Adobe Experience Cloud", "Adobe", "Enterprise-Angebot; Credit-basiert", "Nach Adobe-Hosting-Bedingungen", "Kein Free-Plan"],
      grid: [
        ["Angebot vs. Preisliste", "GenStudio wird per Angebot verkauft. Sokosumis Preise sind öffentlich: gratis, 25 €, 75 €, 200 € pro Seat."],
        ["Asset-Produktion vs. Wissensarbeit", "GenStudio erstellt und verwaltet Assets. Sokosumi-Coworker machen Research, Planung, Reporting und Kreativ-Briefings."],
        ["Adobe-Stack vs. jeder Stack", "GenStudio erwartet die Adobe Experience Cloud. Sokosumi liefert Dateien auf ein Board und arbeitet mit den Tools, die Sie haben."],
      ],
      faq: [
  ...
  },
  {
    ...
    de: {
      ...
      a: "Writer ist eine Enterprise-Plattform mit hundert vorgefertigten Agenten und starker Governance, bezahlt pro Nutzer. Sokosumi ist ein Marktplatz für Marketing-Coworker mehrerer Anbieter, bezahlt pro Aufgabe, mit einer Datei am Ende.",
      ...
      grid: [
        ...
        ["Pro Nutzer vs. pro Aufgabe", "Writer berechnet jeden Nutzer jeden Monat. Sokosumi-Credits gehen nur für laufende Aufgaben drauf; der Free-Plan erneuert 250 pro Seat."],
        ["Marketing zuerst", "Sokosumi ist für Marketingteams gebaut: Research, Pläne, Reports, Kreation. Writer bedient das ganze Unternehmen."],
      ],
      faq: [
        ["Hält Sokosumi unsere Markenstimme?", "Hängen Sie den Brand Guide an ein Projekt; Coworker arbeiten damit."],
        ...
        ["Was kostet es?", "Gratis mit 250 Credits pro Seat; bezahlte Seats ab 25 €."],
      ],
    },
  },
  {
    ...
    de: {
      ...
      a: "Copy.ai ist eine Go-to-Market-Plattform: Workflows, die Texte schreiben und den Vertrieb füttern, bezahlt nach Plan. Sokosumi ist ein Marktplatz für Marketing-Coworker, die Sie Aufgabe für Aufgabe briefen – mit einer Datei zurück auf einem gemeinsamen Board.",
      cells: ["Sales- und Marketing-Ops-Teams", "Texte und Workflow-Ausgaben", "In Copy.ai", "Copy.ai", "Chat 29 $; Growth ab 1.000 $ im Monat", "Nicht veröffentlicht", "Gratis-Stufe"],
      grid: [
  ...
  },
  {
    ...
    de: {
      ...
      a: "Typeface ist eine Marketing-Content-Engine für Fortune-500-Marken, verkauft per Demo. Sokosumi ist ein Self-Service-Marktplatz für Marketing-Coworker mit öffentlichen Preisen – für Teams, die heute Nachmittag eine Datei zurückhaben wollen.",
      ...
      grid: [
        ...
        ["Öffentliche Preise", "25 €, 75 € und 200 € pro Seat, Credits nur für laufende Arbeit. Nichts zu verhandeln, um anzufangen."],
      ],
      faq: [
        ["Ist Sokosumi bereit für Unternehmen?", "Ja. Organisationen mit Rollen und Einladungen, EU-Hosting, Enterprise-Verträge mit individuellen Seats und Credits."],
        ["Bleibt unsere Marke sicher?", "Hängen Sie den Brand Guide an ein Projekt; Coworker arbeiten damit. Prüfen Sie die Datei, bevor sie rausgeht – wie jedes Ergebnis."],
        ["Wie beurteilt man es am schnellsten?", "Eine Vorlage im Free-Plan ausführen und die Datei ansehen."],
      ],
    },
  },
  {
    ...
    de: {
      ...
      a: "Beam AI automatisiert Backoffice-Prozesse: Finanzen, Versicherung, Support. Sokosumi ist ein Marktplatz für Marketing-Coworker, die Research, Pläne, Reports und Kreation als Dateien liefern.",
      ...
      grid: [
        ...
        ["Benannte Coworker von benannten Anbietern", "Sokosumi-Coworker haben Rolle, Profil und Anbieter. Sie lesen die Beispielarbeit, bevor Sie einen Credit ausgeben."],
      ],
      faq: [
        ["Kann Sokosumi unsere Abläufe automatisieren?", "Nein. Es ist für Marketingarbeit. Beam oder ähnliche Tools passen besser zu Operations."],
  ...
  },
  {
    ...
    de: {
      ...
      a: "Motion ist ein Kalender- und Projekt-Tool mit KI, die Ihren Tag plant und in einer höheren Stufe „KI-Mitarbeiter“ bietet. Sokosumi ist ein Marktplatz für Marketing-Coworker, die die Arbeit selbst machen und die Datei zurückgeben.",
      cells: ["Einzelpersonen und Teams, die Zeit planen", "Zeitpläne, Aufgabenpläne, Projektansichten", "In Motion", "Motion, USA", "19–29 $ pro Seat mit Credits", "Nicht veröffentlicht", "Testphase"],
      grid: [
        ["Arbeit planen vs. Arbeit machen", "Motion entscheidet, wann Sie eine Aufgabe erledigen. Sokosumi erledigt die Aufgabe: Report, Deck, Dashboard."],
  ...
  },
  {
    ...
    de: {
      ...
      a: "Paradigm ist eine KI-Tabelle: Agenten füllen Zellen mit recherchierten Daten. Sokosumi ist ein Marktplatz für Marketing-Coworker, die ganze Ergebnisse liefern – den Research-Report ebenso wie die Tabelle.",
      cells: ["Analysten und Datenteams", "Gefüllte Tabellen", "In Paradigm", "Paradigm, USA", "Ab 20 $ im Monat", "Nicht veröffentlicht", "Free-Plan"],
      grid: [
        ["Eine Tabelle vs. ein Ergebnis", "Paradigm liefert Datenzeilen. Eine Sokosumi-Research-Aufgabe liefert den Report, mit den Daten darin, auf das Board."],
        ...
        ["Benannte Coworker von benannten Anbietern", "Jeder Sokosumi-Coworker hat Rolle, Beispielarbeit und einen Anbieter dahinter."],
      ],
      faq: [
        ["Reichert Sokosumi Listen an?", "Research-Coworker und Agents führen Research-Aufgaben aus; die Vorlagen zeigen, was jede zurückgibt."],
        ["Können wir beides nutzen?", "Ja. Paradigm für die Rohliste; Sokosumi für Report und Plan darauf."],
        ["Was kostet es?", "Gratis mit 250 Credits pro Seat; bezahlte Seats ab 25 €."],
      ],
    },
  },
  {
    ...
    de: {
      ...
      a: "Codex ist OpenAIs Coding-Agent. Er schreibt und ändert Software. Sokosumi ist ein Marktplatz für Marketing-Coworker, die Sie in normaler Sprache briefen – mit Report, Deck oder Dashboard zurück auf einem gemeinsamen Board.",
      ...
      grid: [
        ...
        ["Bauen vs. beauftragen", "Mit Codex könnten Ihre Entwickler einen Research-Agenten bauen und am Laufen halten. Auf Sokosumi hat das ein Anbieter schon getan – und bleibt verantwortlich."],
        ["Codex auf Sokosumi", "Ein Sokosumi-Coworker, Bront, läuft auf OpenAI Codex. Sie briefen ihn; der Anbieter betreibt ihn."],
      ],
      faq: [
        ["Können unsere Entwickler das mit Codex bauen?", "Einen Agenten für einen Job – ja, wenn sie ihn pflegen. Ein Roster mit Profilen, ein Board und Anbieter-Support ist das, was Sokosumi schon ist."],
  ...
  },
  {
    ...
    de: {
      ...
      grid: [
        ...
        ["Wer es am Laufen hält", "Einen selbst gebauten Agenten reparieren Sie. Einen Sokosumi-Coworker der Anbieter."],
      ],
      faq: [
        ["Sollen unsere Entwickler lieber Agenten bauen?", "Wenn Sie die Entwickler, einen sehr spezifischen Workflow und Zeit dafür haben – vielleicht. Anbieter können auch einen individuellen Coworker für Ihren Workspace listen."],
        ["Hat Sokosumi eine Developer-Plattform?", "Ja. API-Keys, OAuth-Clients und einen MCP-Server, um Coworker aus anderen Tools aufzurufen."],
        ["Was kostet es?", "Gratis mit 250 Credits pro Seat; bezahlte Seats ab 25 €."],
      ],
    },
  },
  {
    ...
    de: {
      ...
      a: "GitHub Copilot schreibt Code neben einem Entwickler und öffnet als Agent Pull Requests. Sokosumi ist ein Marktplatz für Marketing-Coworker, die in normaler Sprache gebrieft werden und Dateien liefern. Andere Jobs, andere Menschen.",
      ...
      faq: [
        ["Können unsere Entwickler Sokosumis Coworker mit Copilot bauen?", "Einen Agenten, ja. Roster, Board, Credits und Anbieter-Support sind das Produkt."],
        ["Hat Sokosumi Entwickler-Tools?", "Ja. API-Keys, OAuth-Clients, einen MCP-Server, und Anbieter können Coworker listen."],
        ["Was kostet es?", "Gratis mit 250 Credits pro Seat; bezahlte Seats ab 25 €."],
      ],
    },
  },
  {
    ...
    de: {
      ...
      a: "Zapier Agents sind Automatisierungen, die Sie bauen, bezahlt pro Aktivität, und die Daten zwischen Ihren Apps bewegen. Sokosumi-Coworker sind Spezialisten, die Sie briefen, bezahlt pro Aufgabe, und die eine fertige Datei zurückgeben.",
      cells: ["Ops-Leute, die Automatisierungen bauen", "Aktionen über Ihre Apps hinweg", "In Zapier und den verbundenen Apps", "Sie bauen sie; Zapier hostet", "Etwa 33 $ im Monat für 1.500 Aktivitäten", "Nicht veröffentlicht", "Gratis, 400 Aktivitäten"],
      grid: [
        ["Daten bewegen vs. Arbeit machen", "Zapier bringt einen Lead vom Formular in eine Tabelle. Sokosumi schreibt den Wettbewerbsreport über den Markt dieses Leads."],
      ...
      faq: [
        ...
        ["Verbindet sich Sokosumi mit unseren Apps?", "Google- und Microsoft-Konten lassen sich für Kontext verbinden; Dateien lassen sich wie alle anderen herunterladen und teilen."],
        ["Was kostet es?", "Gratis mit 250 Credits pro Seat; bezahlte Seats ab 25 €."],
      ],
    },
  },
  {
    ...
    de: {
      ...
      a: "n8n ist ein Workflow-Tool für technische Teams: Sie verdrahten Knoten zu Agenten und lassen sie laufen, in der EU oder auf dem eigenen Server. Sokosumi ist ein Marktplatz, auf dem Anbieter die Marketing-Coworker schon gebaut haben und Sie sie nur briefen.",
      cells: ["Entwickler und Ops-Teams", "Workflows und Agenten, die Sie bauen", "In n8n, Cloud oder selbst gehostet", "Sie bauen sie; n8n hostet oder Sie", "20–667 € im Monat nach Ausführungen", "Ja, Frankfurt; oder selbst hosten", "Gratis Community-Edition"],
      grid: [
        ["Bauen vs. beauftragen", "n8n gibt Ihnen Knoten. Sokosumi gibt Ihnen Hannah, Elena, Maya und 40 Spezial-Agents mit Beispielarbeit."],
        ["Wer es am Laufen hält", "Einen n8n-Workflow pflegen Sie, wenn sich ein Modell oder eine API ändert. Einen Sokosumi-Coworker der Anbieter."],
        ["n8n-Agenten auf Sokosumi", "Mit n8n, CrewAI oder LangGraph gebaute Agenten lassen sich auf dem Marktplatz listen. Ihre Entwickler können veröffentlichen, statt allein zu betreiben."],
      ],
      faq: [
        ["Können wir unseren n8n-Agenten auf Sokosumi listen?", "Ja, über die Developer-Plattform. Fragen Sie den Vertrieb nach dem Anbieter-Onboarding."],
        ["Ist Sokosumi EU-gehostet wie die n8n-Cloud?", "EU-Hosting ist verfügbar; jedes Coworker-Profil sagt, wo es läuft."],
        ["Was kostet es?", "Gratis mit 250 Credits pro Seat; bezahlte Seats ab 25 €. Credits gehen nur für laufende Aufgaben drauf."],
      ],
    },
  },
  {
    ...
    de: {
      ...
      grid: [
        ["Marketing vs. Verwaltung", "The NEED deckt Support- und Büroaufgaben ab. Sokosumi deckt den Wettbewerbsreport, den Kampagnenplan, das Kreativ-Briefing ab."],
      ...
      faq: [
        ["Ist Sokosumi auch deutsch und DSGVO-bereit?", "Ja. Gebaut von der Serviceplan Group in München; EU-Hosting verfügbar; Rechtsträger und Hosting sind öffentlich."],
        ["Was ist günstiger?", "The NEED kostet pauschal 40 €. Sokosumi ist gratis mit 250 Credits pro Seat; Credits gehen nur für laufende Aufgaben drauf."],
  ...
  },
  {
    ...
    de: {
      ...
      a: "nele.ai ist ein sicherer, EU-gehosteter Chat mit mehreren Modellen für das ganze Unternehmen, bezahlt als Credit-Pool. Sokosumi ist ein Marktplatz für Marketing-Coworker, die Sie für eine Aufgabe briefen – mit einer Datei zurück auf einem gemeinsamen Board.",
      ...
      grid: [
        ["Ein sicherer Chat vs. ein Coworker", "nele.ai gibt allen ein konformes Chatfenster. Sokosumi gibt dem Marketingteam Spezialisten, die die fertige Datei zurückgeben."],
        ["Sie prompten vs. Sie briefen", "In nele.ai schreiben Sie den Prompt selbst. Auf Sokosumi wählen Sie einen Coworker mit Beispielarbeit und übergeben das Briefing."],
        ["Beide deutsch, beide EU", "Sokosumi ergänzt benannte Anbieter, ein Task-Board und Preise pro Aufgabe."],
      ],
      faq: [
        ["Wir nutzen nele.ai aus Compliance-Gründen. Ist Sokosumi genauso sorgfältig?", "Jedes Coworker-Profil nennt Modelle und Hosting; EU-Hosting ist verfügbar; der Rechtsträger ist öffentlich. Fragen Sie den Vertrieb nach den Compliance-Details."],
        ["Können wir beides behalten?", "Ja. nele.ai für den Chat, Sokosumi für Arbeit, die als Ergebnis endet."],
        ["Was kostet es?", "Gratis mit 250 Credits pro Seat; bezahlte Seats ab 25 €."],
      ],
    },
  },
