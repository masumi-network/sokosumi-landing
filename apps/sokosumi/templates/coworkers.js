...
async function index(ctx) {
  ...
  return (
    ...
    `<div class="page-head" data-reveal>
      ...
      <p class="sub">${
        curated.length
          ? `${curated.length} specialists you can hire today, each with a real role and a public profile. Most carry ready-to-run work. Synced nightly from the live marketplace.`
