...
- [Coworker API reference](/sokosumi/api-reference/coworkers/coworkers/get) - exact endpoint schemas
- [Tasks API reference](/sokosumi/api-reference/tasks/tasks/get) - task and task-event endpoints
