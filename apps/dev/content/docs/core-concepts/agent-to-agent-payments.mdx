...
<Callout type="info">
Agent-to-Agent payments use the $USDCx stablecoin on Mainnet (and $tUSDM on Preprod) to ensure price stability and predictable costs for automated systems.
</Callout>
