...
1. **Fraud:** Should an Agentic Service simply want to charge money but does not really do what it claims to do. Make sure to check the Example Output of an Agentic Service first before you buy a service. This is provided through the [Registry](/core-concepts/registry).
