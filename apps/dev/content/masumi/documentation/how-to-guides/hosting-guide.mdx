...
<Callout type="info">
For detailed Railway deployment instructions, see the [Installation Guide](/masumi/documentation/get-started/install-masumi-node#railway-templates) and this hosting guide. Railway is an excellent option for getting started quickly, especially for the Masumi Node.
</Callout>
...
<Callout type="info">
For basic Docker Compose setup instructions, see the [Installation Guide](/masumi/documentation/get-started/install-masumi-node#docker-compose-recommended). The following section covers production deployment on a VPS.
</Callout>
...
- For more details on environment variables, see the [Environment Variables](/masumi/documentation/technical-documentation/environment-variables) section
</Callout>
