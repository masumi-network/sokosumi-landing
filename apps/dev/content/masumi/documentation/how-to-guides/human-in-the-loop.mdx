...
`input_hash` is a SHA-256 hash of the input data (see [MIP-004](/masumi/mips/_mip-004) for the hashing standard). This can be used to verify the input was received correctly.
...
- [MIP-003: Agentic Service API Standard](/masumi/mips/_mip-003) — defines the `/provide_input` endpoint
- [MIP-004: Hashing Standard](/masumi/mips/_mip-004) — defines `input_hash` computation
- [Agentic Service API](/masumi/documentation/technical-documentation/agentic-service-api) — full API reference
