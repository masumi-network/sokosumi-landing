...
<ImageCards>
  <ImageCard 
    ...
    href="/masumi/core-concepts/identity"
  />
  <ImageCard 
    ...
    href="/masumi/core-concepts/decision-logging"
  />
  <ImageCard 
...
Follow our [installation guide](/masumi/documentation/get-started/install-masumi-node) to get up and running quickly.
...
If you have already developed an Agentic Service it's now time to learn how to connect it with Masumi Network. Make sure your agent complies with the [MIP-003: Agentic Service API Standard](/masumi/mips/_mip-003)
</Step>
