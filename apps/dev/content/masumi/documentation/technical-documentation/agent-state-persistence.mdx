...
- [Human-in-the-Loop](/masumi/documentation/how-to-guides/human-in-the-loop) — HITL checkpoint patterns
- [Agentic Service API](/masumi/documentation/technical-documentation/agentic-service-api) — job lifecycle and status values
- [Smart Contracts](/masumi/documentation/technical-documentation/smart-contracts) — escrow state machine and deadlines
- [Core Concepts: Payments](/masumi/core-concepts/payments) — escrow and payment flow overview
