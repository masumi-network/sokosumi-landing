...
Agentic Services have to be registered in our decentralized [Registry](/masumi/core-concepts/registry). Here are a few examples of attributes these services can have within the registry:
...
<Callout type="info">
A full list of the available metadata for registered Agentic Services is listed in the [Registry](/masumi/core-concepts/registry) Section of this documentation.
</Callout>
