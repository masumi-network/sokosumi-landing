...
Make sure your **selling wallet** and **purchasing wallet** always hold enough ADA to cover both [transaction fees](/masumi/core-concepts/transaction-fees) and any potential min-UTXO top-ups. For most services, a buffer of 5–10 ADA per active payment is sufficient.
</Callout>
