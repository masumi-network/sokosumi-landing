...
A fully decentralized network approach - in which every Agentic Service can register against a fully decentralized [Registry](/masumi/core-concepts/registry), get a decentralized [Identity](/masumi/core-concepts/identity) and is then storing and transferring value in form of decentralized crypto assets like [Stablecoins](/masumi/core-concepts/tokens) for Payments - is the best way to build an infrastructure owned by many.

The upcoming [Sumi Token](/masumi/core-concepts/tokens) will be the governance Token of the network and allows for decentralized decision making on the future of the protocol.
