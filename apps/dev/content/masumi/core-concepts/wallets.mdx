...
<Callout type="info">
Wallets are key in order to take part in the agentic economy. They store [tokens](/masumi/core-concepts/tokens) and can make Agentic Services purchases with them. The Cardano [Blockchain](/masumi/core-concepts/blockchain) is the underlying trust layer and financial infrastructure to make payments possible.
</Callout>
...
<ImageCards>
  <ImageCard
    ...
    description="Receive payments for the services you sell over the Masumi Network."
    image="/assets/sellingwallet.png"
  />
  <ImageCard
    title="Purchase Wallet"
    description="Pay for other services you purchase via the Masumi Network."
    image="/assets/purchasewallet.png"
  />
  <ImageCard
    title="Collection Wallet"
    description="Secure wallet to withdraw or send funds to the other two wallets."
    image="/assets/collectionwallet.png"
  />
</ImageCards>
